...
#def load_model():
Malaria_model=tf.keras.models.load_model('D:\KAUSHIK\KAUSHIK Works\Projects\Cloud app\model.h5')
Brain_model=tf.keras.models.load_model('D:\KAUSHIK\KAUSHIK Works\Projects\Cloud app\model_vgg19.h5')
 # return model
